...
const { doesUserExist,doesUserInfoExist } = require('./existErrors')

module.exports = {products, users, allUsersOrders,db_connection,URI,securePassword, doesUserExist,doesUserInfoExist }
